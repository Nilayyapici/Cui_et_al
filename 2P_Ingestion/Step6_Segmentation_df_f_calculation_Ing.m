...
ImageTimeWrittenInFileName=1;%Set to 1 to turn on "auto detect imaging time from file name" function. Set to 0 to turn it off.
ImageTimeMin=4;%Change here!!!!!!! This paramter will only be used (to determine imaging time) if ImageTimeWrittenInFileName=0.
ImageTimeSec=0;%Change here!!This paramter will only be used (to determine imaging time) if ImageTimeWrittenInFileName=0.
...
list_of_directories = {...
%     'C:\Users\zjucx\Dropbox\Worki\AvgdFFData-Current\IngstionDFF\222FluoXlsx,NoBGSub\CS,UL50mMNaCl'...
...
%     'C:\Users\zjucx\Dropbox\Worki\AvgdFFData-Current\IngstionDFF\222FluoXlsx,NoBGSub\Wiso'...
%     'C:\Users\zjucx\Dropbox\Worki\AvgdFFData-Current\IngstionDFF\222FluoXlsx,NoBGSub\MsR1Mut84524'...
%     'C:\Users\zjucx\Dropbox\Worki\AvgdFFData-Current\IngstionDFF\222FluoXlsx,NoBGSub\MyoMut84523'...
%     'C:\Users\zjucx\Dropbox\Worki\AvgdFFData-Current\IngstionDFF\222FluoXlsx,NoBGSub\PiezoKO'...
%     'C:\Users\zjucx\Dropbox\Worki\AvgdFFData-Current\IngstionDFF\222FluoXlsx,NoBGSub\CS,UL50mMNaCl'...
...
% 'C:\Users\zjucx\Dropbox\Worki\AvgdFFData-Current\IngstionDFF\222FluoXlsx,NoBGSub\CEMGCaMP6s,AfterRevision\CDG2,100mMSuc,Fasted'...
% 'C:\Users\zjucx\Dropbox\Worki\AvgdFFData-Current\IngstionDFF\222FluoXlsx,NoBGSub\CEMGCaMP6s,AfterRevision\CDG2,1MSuc,Fasted,Fluo'...
% 'C:\Users\zjucx\Dropbox\Worki\AvgdFFData-Current\IngstionDFF\222FluoXlsx,NoBGSub\CEMGCaMP6s,AfterRevision\CDG2,1MSuc,RefedWS'...
...
for directory_idx  = 1:numel(list_of_directories)
    ...
    for idx1=1:size(XlsxList,1)
        ...
        CurrentXlsxFileName=XlsxList(idx1).name
        [XlsxNum,XlsxTitle]=xlsread(XlsxList(idx1).name);
%---------------Read Imaging Time Length From file name if needed--------
        if ImageTimeWrittenInFileName==0
            TotalTimeInSec=ImageTimeMin*60+ImageTimeSec;
        elseif ImageTimeWrittenInFileName==1
            SplittedFileName=split(CurrentXlsxFileName,'-');
            ImageTimeMin=str2num(SplittedFileName{4}(1));
            TotalTimeInSec=ImageTimeMin*60+ImageTimeSec
        end
