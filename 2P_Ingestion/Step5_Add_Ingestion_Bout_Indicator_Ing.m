...
list_of_directories = {...
    'D:\Drive20BackUp\DataAnalysis\111FluoXlsx,WithBGSub\111FluoXlsx,WithBGSub\CEM,IngWithOpto(ATR-Cont)'...
...
%---------------Read Imaging Time Length From file name if needed--------
        ...
        elseif ImageTimeWrittenInFileName==1
            SplittedFileName=split(CurFileName,'-');
            ImageTimeMin=str2num(SplittedFileName{3}(1));
            TotalTimeSec=ImageTimeMin*60+ImageTimeSec
        end
...
%----------Read ingesiton time information from txt files----------
