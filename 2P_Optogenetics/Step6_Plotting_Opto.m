...
XLimSetting=[-7 8];%This is X limit for 1s stimulation, usually [-7 18] for 1s stim, [-10 to 20] for 10s stim7
% XLimSetting=[-10 20];%This is X limit for 1s stimulation, usually [-7 18] for 1s stim, [-10 to 20] for 10s stim
TimeAxisResolution=0.25;
YStep=0.5;%Set to 0.5 for Fig. 1-2, Set to 0.2 for IN1 activating CEM imaging experiments.
% YLimSetting=[-0.6 1.6];%change here!!!, this is the range for MY figure 1 (-0.5 to 1.5)
YLimSetting=[-0.5 1.5];%change here!!!, this is the range for MY figure 2 (-0.5 to 2.5)
...
%     'C:\Users\zjucx\Dropbox\Worki\AvgdFFData-Current\IN1 imaging\Starved\TMC(p\SA+sBA'...
%     'C:\Users\zjucx\Dropbox\Worki\AvgdFFData-Current\IN1 imaging\Starved\Wiso,St(p\1s'...
...
StimulatorName={'Gr64c'};
% StimulatorName={'EN-1','EN-2','EN-3','EN-4','EN-5',...
...
% StimulatorName={'IN1','+','Gr64a','Gr64d','Gr64f','Gr66a','Ir25a','ppk28','TMC','+'};%Make sure this sequence is in accordance with the input sequence of folders
ImagerName={'IN1','IN1','IN1','IN1','IN1',...
    'IN1','IN1','IN1','IN1','IN1',...
